...
# ===== V327 · SHARK COMBI INTELLIGENCE REAL FULL =====
...
def api_shark_combi_intelligence_v327():
    try:
        ...
        partidos = request.args.get("partidos") or request.args.get("n") or request.args.get("count") or 7
        stake = request.args.get("stake") or 0.10
        modo = request.args.get("modo") or request.args.get("mode") or request.args.get("riesgo") or "balanceado"
        dia = request.args.get("dia") or request.args.get("day") or "hoy"
        payload = build_shark_combi_intelligence(count=partidos, stake=stake, mode=modo, day=dia)
    except Exception as exc:
        payload = {
            "ok": True,
            "version": "V327",
